...
import com.example.dt.List_Test.View.Adapter.CourseAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel.GetAllCourses(Lastindex).observe(this, new Observer<List<Course>>() {
            @Override
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                viewModel.DeleteCourse(adapter.GetCourseAt(viewHolder.getAdapterPosition()));
            }
    ...
    private void LoadData() {
        ...
        call.enqueue(new Callback<ArrayList<Course>>() {
            ...
            public void onResponse(Call<ArrayList<Course>> call, Response<ArrayList<Course>> response) {
                ...
                viewModel.DeleteAlltCources(response.body());
            }
